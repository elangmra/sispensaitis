                    ...
                    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                        ...
                        <nav>
                            <ol class="flex items-center gap-2">
                                ...
                                <li class="font-medium text-primary">Mata Pelajaran</li>
                            </ol>
                        </nav>
                    </div>
                    <!-- Breadcrumb End -->
                        ...
                        <div class="col-span-5">
                            <div class="flex justify-between items-center mb-4">
                                ...
                                <div class="flex items-center align-middle">
                                    ...
                                    <a href="{{ route('matapelajaran.create') }}" class="ml-4 inline-block bg-primary text-white px-4 py-2 rounded-md">Tambah Mata Pelajaran</a>
                                </div>
                            </div>
                            <div
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        <a href="{{ route('matapelajaran.edit', $mapel->id) }}" class="text-indigo-600 hover:text-indigo-900">
                                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 20 20" fill="currentColor">
                                                                <path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z" />
                                                                <path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd" />
                                                            </svg>
                                                        </a>
                                                        <form action="{{ route('matapelajaran.destroy', $mapel->id) }}" method="POST" class="inline" style="margin-bottom: 0px !important;">
                                                            @csrf
                                                            @method('DELETE')
