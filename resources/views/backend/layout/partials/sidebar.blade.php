    ...
    <nav class="mt-5 px-4 py-4 lg:mt-9 lg:px-6" x-data="{selected: $persist('Dashboard')}">
        ...
        <div>
            ...
            <ul class="mb-6 flex flex-col gap-1.5">
                <!-- Menu Item Dashboard -->
                <li>
                    <a class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 {{ Request::routeIs('admin.dashboard') ? 'bg-graydark dark:bg-meta-4' : '' }}"
                ...
                <!-- Menu Item Teacher -->
                <li>
                    <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 {{ Request::routeIs('admin.teacher.index') ? 'bg-graydark dark:bg-meta-4' : '' }}"
                ...
                <!-- Menu Item Student -->
                <li>
                    <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 {{ Request::routeIs('admin.student.index') ? 'bg-graydark dark:bg-meta-4' : '' }}"
                ...
                <!-- Menu Item Class -->
                <li>
                    <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 {{ Request::routeIs('admin.kelas.index') ? 'bg-graydark dark:bg-meta-4' : '' }}"
                ...
                <!-- Menu Item Mapel -->
                <li>
                    <a class="group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 {{ Request::routeIs('admin.matapelajaran.index') ? 'bg-graydark dark:bg-meta-4' : '' }}"
                        href="{{ route('admin.matapelajaran.index') }}">
                        <svg class="fill-current" width="18" height="19" viewBox="0 0 18 19" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_130_9756)">
                                <path
